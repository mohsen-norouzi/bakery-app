...
export function BagIcon({ className = "h-4 w-4" }) {
	return (
		<ShoppingBag className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function ArrowRightIcon({ className = "h-4 w-4" }) {
	return (
		<ArrowRight className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function ArrowLeftIcon({ className = "h-4 w-4" }) {
	return (
		<ArrowLeft className={className} weight="regular" aria-hidden="true" />
	);
}

export function GridIcon({ className = "h-4 w-4" }) {
	return (
		<SquaresFour className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function ArrowDownIcon({ className = "h-4 w-4" }) {
	return (
		<ArrowDown className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function StorefrontIcon({ className = "h-4 w-4" }) {
	return (
		<Storefront className={className} weight="regular" aria-hidden="true" />
	);
}

export function InstagramIcon({ className = "h-4 w-4" }) {
	return (
		<InstagramLogo className={className} weight="regular" aria-hidden="true" />
	);
}

export function WhatsappIcon({ className = "h-4 w-4" }) {
	return (
		<WhatsappLogo className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function CookingPotIcon({ className = "h-4 w-4" }) {
	return (
		<CookingPot className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function MailIcon({ className = "h-4 w-4" }) {
	return (
		<EnvelopeSimple className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function ShieldCheckIcon({ className = "h-4 w-4" }) {
	return (
		<ShieldCheck className={className} weight="regular" aria-hidden="true" />
	);
}
...
export function CaretDownIcon({ className = "h-4 w-4" }) {
	return (
		<CaretDown className={className} weight="regular" aria-hidden="true" />
	);
}
