...
export const NOTES = {
	...
	"note-4": {
		src: "/img/feedbacks/note-4.webp",
		ratio: 1170 / 932,
		tilt: 0,
		pad: { top: 11, right: 10, bottom: 11, left: 10 },
	},
	"note-5": {
		src: "/img/feedbacks/note-5.webp",
		ratio: 1199 / 983,
		tilt: 0,
